...
pub static PRICING: LazyLock<HashMap<&'static str, ModelPricing>> = LazyLock::new(|| {
    ...
    m.insert("anthropic.claude-3-5-sonnet-20240620-v1:0", sonnet_35_old.clone());
    ...
    m.insert("anthropic.claude-3-7-sonnet-20250219-v1:0", sonnet_37.clone());
    ...
    m.insert("anthropic.claude-sonnet-4-5-20250929-v1:0", sonnet_4x.clone());
    ...
    // --- Legacy ---
    m.insert("anthropic.claude-instant-v1", ModelPricing::new(mtok(0.80), mtok(2.40), 0.0, 0.0));
    m.insert("anthropic.claude-v1", ModelPricing::new(mtok(8.0), mtok(24.0), 0.0, 0.0));
    m.insert("anthropic.claude-v2:1", ModelPricing::new(mtok(8.0), mtok(24.0), 0.0, 0.0));
...
fn calculate_from_tokens(record: &RawRecord) -> f64 {
    ...
    cost += tiered_cost(usage.output_tokens, pricing.output, pricing.output_above_200k);
    cost += tiered_cost(
