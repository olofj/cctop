            ...
            if is_expanded {
                ...
                for (proj_name, model_agg) in &gm.projects {
                    ...
                    rows.push(DisplayRow {
                        ...
                        cost_window: model_agg.core.cost,
